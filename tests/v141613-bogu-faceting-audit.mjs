...
assert.match(html,/data-forge-filter="bogu">보구</);assert.match(html,/id="forgeBoguPanel"/);assert.match(html,/bogu-v14-16-13\.js\?v=141614/);assert.match(html,/bogu-v14-16-13\.css\?v=141614/);
...
assert.match(save,/const VERSION=19/);assert.match(save,/boguGems/);assert.match(save,/boguEquipped/);assert.match(save,/boguFaceting/);assert.match(state,/boguGems:\[\]/);assert.match(power,/BoguSystem\?\.combatPowerFactor/);assert.match(css,/\.bogu-facet-nodes/);assert.match(sw,/cheonha-v14-16-14-bogu-ui-assets/);
