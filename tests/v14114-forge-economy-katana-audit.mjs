...
ok(save.includes('const VERSION=19')&&save.includes('gachaMileage')&&save.includes('weaponSoulStones')&&save.includes('brokenWeapons')&&save.includes('artisanBreath'),"save migration missing");
