...
const req=[
 ...
 [vfx.includes('skillSaberUnityThunder:{src:"assets/vfx/skills/saber/unity_thunder.png"'),"VFX1 등록"],
 [vfx.includes('skillSaberWhirlwindUser:{src:"assets/vfx/skills/saber/whirlwind.png"'),"VFX3 등록"],
 [vfx.includes('skillSaberUnityMountain:{src:"assets/vfx/skills/saber/unity_mountain.png"'),"VFX4 등록"],
 [vfx.includes('def.cols||def.frames'),"그리드 시트 프레임 지원"],
 [loader.includes('assets/vfx/skills/saber/unity_thunder.png')&&loader.includes('assets/vfx/skills/saber/whirlwind.png')&&loader.includes('assets/vfx/skills/saber/unity_mountain.png'),"에셋 선로딩"]
];
