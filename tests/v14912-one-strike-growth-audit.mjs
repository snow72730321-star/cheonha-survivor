...
ok(index.includes("천하생존록 v14.9.13")&&index.includes('content="v14.9.13-golden-dragon-vfx-align"'),"HTML 최신 버전 표기 누락");
ok(sw.includes('cheonha-v14-9-13-golden-dragon-vfx-align'),"서비스워커 최신 캐시 버전 누락");
