...
ok(index.includes("천하생존록 v14.9.12")&&index.includes('content="v14.9.12-one-strike-growth"'),"HTML 버전 표기 누락");
ok(sw.includes('cheonha-v14-9-12-one-strike-growth'),"서비스워커 캐시 버전 누락");
