...
for(const sig of [
  'skillFistTiger:{id:"skillFistTiger",fw:512,fh:206,sourceX:46,sourceY:103',
  ...
  'skillFistGoldenCharge:{id:"skillFistGoldenCharge",fw:822,fh:663,sourceX:260,sourceY:340'
...
ok(meta.includes('muzzle=(650-260)*chargeScale'),"charge muzzle is not tied to actual orb anchor");
