...
const expected={sword:'damage:48',spear:'62,330',bow:'type:"ricochetVolley"',poison:'damage:24,life:6.2',tao:'Math.min(24,targets.length)',saber:'i<5',katana:'i<12',fist:'78,300'};
