...
assert.ok(fs.existsSync("assets/vfx/user/meteor_sword_rain_user.png"));
assert.ok(!fs.existsSync("assets/vfx/skills/sword_meteor_rain.png"));
assert.match(vfx,/skillSwordMeteor:\{src:"assets\/vfx\/user\/meteor_sword_rain_user\.png",frameW:183,frameH:284,frames:10,cols:5,fps:11\.11/);
assert.match(loader,/assets\/vfx\/user\/meteor_sword_rain_user\.png/);
