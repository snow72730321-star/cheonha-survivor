...
assert.equal(read("BUILD.txt").split(/\r?\n/)[0],"v14.15.7-cumulative-root");
assert.match(html,/forge-mobile-v14-15-3-device-fix\.css\?v=14157/);
assert.match(html,/js\/systems\/forge-v13\.js\?v=14157/);
assert.match(html,/js\/render\/weapon-visuals-v14-4\.js\?v=14157/);
assert.match(html,/js\/systems\/katana-rework-v15\.js\?v=14157/);
...
console.log("v14.15.7 cumulative root deploy audit: OK");
