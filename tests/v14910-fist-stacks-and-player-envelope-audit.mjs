...
ok(sprite.includes('skillFistGoldenDragon:{id:"skillFistGoldenDragon",fw:1304,fh:516,sourceX:1189,sourceY:278,scale:Math.max(.46,r/1304),flipX:true}'),"황룡십팔장 VFX 방향 복구 누락");
...
ok(remaster.includes('황룡 ${h}/20')&&remaster.includes('만권 ${m}/3'),"장권 스택 HUD 누락");
