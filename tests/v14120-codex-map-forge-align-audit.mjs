...
ok(html.includes('v14.12.0-codex-map-forge-align')||html.includes('v14.12.1-artisan-breath-nerf')||html.includes('v14.12.2-forge-hitbox-scroll-polish'),"v14.12 build metadata missing");
...
ok((sw.includes('cheonha-v14-12-0-codex-map-forge-align')||sw.includes('cheonha-v14-12-1-artisan-breath-nerf')||sw.includes('cheonha-v14-12-2-forge-hitbox-scroll-polish'))&&sw.includes('js/systems/world-map-v14-12.js'),"v14.12 PWA world map cache missing");
