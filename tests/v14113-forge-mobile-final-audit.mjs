...
ok(html.includes('v14.16.1-raid-three-phase')&&html.includes('forge-mobile-final-v14-11-1.css')&&html.includes('forge-mobile-final-v14-11-1.js'),"build/css/js wiring missing");
...
ok(sw.includes('cheonha-v14-16-1-raid-three-phase')&&sw.includes('isForgeUiArt')&&sw.includes('js/ui/forge-mobile-final-v14-11-1.js'),"PWA runtime cache missing final forge policy");
