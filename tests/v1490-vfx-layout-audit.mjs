...
for(const f of allFiles.filter(f=>/\.(png|gif)$/i.test(f))){
  const hay=["js/core/asset-loader.js","js/systems/katana-rework-v15.js","js/vfx/sprite-vfx-v14-3-8.js","js/vfx/awakening-cutscene-v14-3-8.js","service-worker.js"].map(p=>fs.readFileSync(p,"utf8")).join("\n");
