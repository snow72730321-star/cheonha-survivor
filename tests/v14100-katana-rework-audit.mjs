...
ok(!fs.existsSync(path.join(root,"assets/ui/katana")),"왜도 VFX가 assets/ui에 남아 있음");
ok(!fs.existsSync(path.join(root,"assets/vfx/skills/katana/star_sheet.png")),"미사용 극월 star_sheet가 VFX 폴더에 남아 있음");
ok(!k.includes('img("star_sheet.png")')&&!loader.includes('star_sheet.png')&&!sw.includes('star_sheet.png'),"극월 HUD가 여전히 star_sheet를 런타임에서 사용함");
