...
ok(state.includes('name:"참월·절월"')&&state.includes('name:"경화수월"')&&state.includes('ready:p=>false'),"히든 구성/경화수월 보류 누락");
...
const files=["assets/ui/katana/full_moon_stack.png","assets/ui/katana/moonflower.png","assets/ui/katana/star_sheet.png","assets/ui/katana/star_ring.png","assets/ui/katana/moon_scar_stack.png","assets/vfx/skills/katana/full_moon.gif","assets/vfx/skills/katana/moon_scar_burst.gif","assets/vfx/skills/katana/moon_execute.gif","assets/vfx/skills/katana/silver_moon_hit.gif","assets/vfx/skills/katana/balwol.gif","assets/vfx/skills/katana/balwol_echo.gif","assets/vfx/skills/katana/moon_sword_1.gif","assets/vfx/skills/katana/moon_sword_2.gif","assets/vfx/skills/katana/moon_sword_3.gif","assets/vfx/skills/katana/chamwol.gif","assets/vfx/skills/katana/jeolwol.gif","assets/vfx/skills/katana/moon_buff.gif","assets/vfx/skills/katana/time_space_cut.gif"];
