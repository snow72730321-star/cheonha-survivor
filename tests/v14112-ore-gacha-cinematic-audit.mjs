...
ok(sw.includes('assets/ui/ore-gacha-draw.gif')&&(sw.includes('cheonha-v14-10-2-ore-gacha-cinematic')||sw.includes('cheonha-v14-11-1-forge-mobile-final')||sw.includes('cheonha-v14-11-2-forge-economy-katana')),"뽑기 연출 PWA 캐시 누락");
