...
ok(sprite.includes('skillFistGoldenCharge:{id:"skillFistGoldenCharge",fw:822,fh:663,sourceX:180,sourceY:384,scale:.56,angleOffset:Math.PI,forwardOffset:96,upright:true}'),"charge energy-orb anchor missing");
