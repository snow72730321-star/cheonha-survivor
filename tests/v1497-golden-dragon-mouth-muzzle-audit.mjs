...
ok(sprite.includes('skillFistGoldenCharge:{id:"skillFistGoldenCharge",fw:822,fh:663,sourceX:562,sourceY:340,scale:.56,angleOffset:Math.PI'),"charge facing correction missing");
ok(meta.includes('chargeRenderA=castA+Math.PI'),"charge render angle not shared by muzzle transform");
ok(meta.includes('mouthLocalX=(174-562)*chargeScale'),"dragon mouth X anchor missing");
ok(meta.includes('mouthLocalY=-(381-340)*chargeScale'),"dragon mouth Y anchor missing");
