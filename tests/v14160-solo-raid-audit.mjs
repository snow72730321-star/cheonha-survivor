...
assert.match(html,/content="v14\.16\.5-performance-sword-balance" name="game-build"/);
...
assert.match(map,/SoloRaidMode\?\.active/);assert.match(sw,/const CACHE="cheonha-v14-16-5-performance-sword"/);
