...
assert.match(html,/content="v14\.16\.4-raid-endgame" name="game-build"/);
...
assert.match(map,/SoloRaidMode\?\.active/);assert.match(sw,/const CACHE="cheonha-v14-16-4-raid-endgame"/);
