...
ok(vfx.includes('skillFistGoldenCharge:{id:"skillFistGoldenCharge",fw:822,fh:663,sourceX:174,sourceY:340')&&vfx.includes('scale:.56')&&vfx.includes('upright:true'),"황룡진천 charge orientation missing");
