...
assert.equal(pkg.version,"14.15.3");
assert.match(html,/v14\.15\.3-cumulative-root/);
assert.match(loader,/const BUILD="v14\.15\.3-cumulative-root"/);
...
console.log("v14.15.3 stability/memory hardening audit: OK");
