...
assert.equal(pkg.version,"14.16.5");
assert.match(html,/v14\.16\.5-performance-sword-balance/);
assert.match(loader,/const BUILD="v14\.16\.5-performance-sword-balance"/);
...
console.log("v14.16.2 stability/memory hardening audit: OK");
