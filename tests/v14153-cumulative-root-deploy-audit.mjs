...
assert.equal(read("BUILD.txt").split(/\r?\n/)[0],"v14.15.3-cumulative-root");
assert.match(html,/forge-mobile-v14-15-3-device-fix\.css\?v=14153/);
assert.match(html,/js\/systems\/forge-v13\.js\?v=14153/);
assert.match(html,/js\/render\/weapon-visuals-v14-4\.js\?v=14153/);
assert.match(sw,/cheonha-v14-15-3-cumulative-root/);
...
console.log("v14.15.3 cumulative root deploy audit: OK");
