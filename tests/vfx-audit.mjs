...
if(pngs.length<54)throw new Error(`VFX 에셋 수 부족: ${pngs.length}`);
...
for(const required of ["skillSwordMeteor","skillSpearSpin","skillBowArrowRain","skillPoisonThousand","skillTaoIceArray","skillSaberWhirlwind","skillKatanaNameless","skillFistTaiji"]){
...
if(skillPngs.length!==25||hashes.size!==25)throw new Error(`무공 전용 VFX가 누락되었거나 중복됨: ${skillPngs.length}개 / 고유 ${hashes.size}개`);
