...
ok(sprite.includes('sourceX:180,sourceY:384,scale:.56,angleOffset:Math.PI,forwardOffset:96,upright:true'),"charge energy-orb source anchor missing");
...
ok(sprite.includes('VFXSprites.draw(cfg.id,x,y,{age:animAge,loop:true'),"charge animation is not looping");
