...
ok(html.includes("v14.9.15-katana-gif-hit-fix")&&html.includes("panel codex-panel"),"v14.9.15 도감 HTML/현재 빌드 표기 누락");
ok(sw.includes("cheonha-v14-9-15-katana-gif-hit-fix"),"v14.9.15 현재 캐시 키 누락");
