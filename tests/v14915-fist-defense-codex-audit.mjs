...
ok(html.includes("v14.16.4-raid-endgame")&&html.includes("panel codex-panel"),"도감 HTML/현재 빌드 표기 누락");
ok(sw.includes("cheonha-v14-16-4-raid-endgame"),"현재 캐시 키 누락");
ok(pkg.version==="14.16.4","package version not bumped to 14.16.4");
