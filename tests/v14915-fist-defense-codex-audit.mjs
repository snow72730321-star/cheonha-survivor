...
ok((html.includes("v14.9.15-system-overhaul")||html.includes("v14.10.1-ore-gacha-jeolwol-frame-fix")||(html.includes("v14.10.2-ore-gacha-cinematic")||html.includes("v14.11.0-forge-art-ui")))&&html.includes("panel codex-panel"),"도감 HTML/현재 빌드 표기 누락");
ok((sw.includes("cheonha-v14-10-2-ore-gacha-cinematic")||sw.includes("cheonha-v14-11-0-forge-art-ui")),"현재 캐시 키 누락");
