...
ok(html.includes("v14.15.1-combat-safety-balance-ui")&&html.includes("panel codex-panel"),"도감 HTML/현재 빌드 표기 누락");
ok(sw.includes("cheonha-v14-15-1-combat-safety-balance-ui"),"현재 캐시 키 누락");
ok(pkg.version==="14.15.1","package version not bumped to 14.15.1");
