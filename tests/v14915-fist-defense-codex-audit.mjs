...
ok(html.includes("v14.9.15-ten-thousand-defense-codex")&&html.includes("panel codex-panel"),"v14.9.15 도감 HTML 표기 누락");
ok(sw.includes("cheonha-v14-9-15-ten-thousand-defense-codex"),"v14.9.15 캐시 키 누락");
