...
ok((k.includes('if(n==="1")flipX=true')||k.includes('if(n==="1"||n==="3")flipX=true')),"월영참 1식 수평 반전 누락");
ok(/"jeolwol":\{[^}]*fw:773,fh:435,frames:52,[^}]*d:Array\(52\)\.fill\(50\),total:2600\}/.test(k),"절월 프레임 타이밍이 의도치 않게 변경됨");
