...
ok(sprite.includes('flipY:true,backwardOffset:124'),"charge flipY/backward offset regression");
...
ok(meta.includes('chargeBack=124'),"muzzle transform backward offset missing");
ok(meta.includes('mouthLocalY=-(381-340)*chargeScale'),"mouth anchor Y flip missing");
