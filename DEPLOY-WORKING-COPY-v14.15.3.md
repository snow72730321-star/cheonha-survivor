...
5. 배포 주소의 `/BUILD.txt`를 열어 `v14.15.3-cumulative-root`가 보이는지 확인합니다.
6. iPhone에서 예전 화면이 남으면 Safari 탭을 닫고 다시 연 뒤 한 번 새로고침합니다.

중요: `index.html`이 `cheonha-survivor-v14.15.3/` 같은 하위 폴더 안으로 들어가면 GitHub Pages 루트 배포가 되지 않습니다.
