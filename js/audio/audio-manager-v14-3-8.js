...
/**
 * v14.3.8 호환 진입점. 검증된 v14.3.6 모바일 최적화 구현을 복구한 파일 기반 오디오 엔진.
 *
 * 핵심 원칙
...
const GameAudio=(()=>{
  ...
  function registerBuiltIns(){
    ...
    define("attack-saber","saber-greatblade-v1436.wav",{...attack,priority:2,maxInstances:1,volume:.80,cooldownMs:210,rateMin:.985,rateMax:1.01});
    define("attack-katana","katana-iai-sharp-v1435.wav",{...attack,volume:.78,cooldownMs:170,rateMin:.995,rateMax:1.005});
    ...
    define("saber-attack","saber-greatblade-v1436.wav",{...attack,priority:2,maxInstances:1,volume:.78,cooldownMs:210,rateMin:.985,rateMax:1.01});
    define("katana-slash","katana-iai-sharp-v1435.wav",{...attack,volume:.74,cooldownMs:160,maxInstances:1,rateMin:.995,rateMax:1.005});
