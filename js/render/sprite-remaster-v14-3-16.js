...
window.__CHEONHA_RENDERER_MODE__="external-png-assets-dynamic-frame-v14316";
...
drawPlayer=function(){
  ...
  if(!drawAdvancedPlayerFrame(selectedWeapon,action,pose.dir,cx,cy,1)){
    // 행동별 고급 시트가 없으면 하단 마감과 안전 여백이 복원된 외부 144×208 PNG 시트를 사용한다.
