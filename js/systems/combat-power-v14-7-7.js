...
const CombatPowerSystem=(()=>{
  ...
  function equippedPower(weaponId){const base=value(equipped(weaponId)),factor=window.BoguSystem?.combatPowerFactor?.()||1;return Math.max(0,Math.round(base*factor))}
