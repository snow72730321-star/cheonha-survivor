...
function drawKatanaVisuals(){
 ...
 for(const v of ordered){
  ...
  if(f)drawAnim(f,v.age||0,dx,dy,w,h,opacity,rot,false);
 }
}
...
window.KatanaRework={version:"1.4",flowerGain,addScar,gainMoonPhase,gainExtremeMoon,activateGyeonghwa,isGyeonghwaActive};
})();
