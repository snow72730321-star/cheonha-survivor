...
(function installForgeV13(){
  ...
  function executeEnhance(){
    ...
    account.gold-=cost;setEnhancementBusy(true);saveAccountData();updateForgeLiveGold(); scene.className="anvil-scene striking"; message.className="forge-result-message"; message.textContent="장인이 호흡을 가다듬고 망치를 내리친다…"; GameAudio.playUI("forge-strike");
    setTimeout(()=>{
      let destroyed=false;
      try{
        ...
        setEnhancementBusy(false);setTimeout(()=>scene.className="anvil-scene",650);
