...
function emitSkillVfx(id,lv=1){const [c1,c2,c3]=vfxPalette(),x=player.x,y=player.y,a=facingAngle();
 ...
 switch(id){
  ...
  case "overlord": VFX10.push({type:"skillSpearOverlord",x,y,a,r:235,life:.96,max:.96,color:c1,width:22+lv*4}); break;
  ...
  case "lifedeath": VFX10.push({type:"skillPoisonLifeDeath",x,y,r:150+lv*16,life:.63,max:.63,color:c1}); break;
  case "firedragon": VFX10.push({type:"skillTaoFireDragon",x,y,a,r:170+lv*14,life:.54,max:.54,color:"#ff8c52",width:28}); break;
  case "icepulse": VFX10.push({type:"skillTaoIceArray",x,y,r:118+lv*13,life:.48,max:.48,color:"#9eeaff"}); break;
  case "fivethunder": VFX10.push({type:"skillTaoFiveThunder",x,y,r:145+lv*13,life:1.23,max:1.23,color:"#c6eaff"}); break;
